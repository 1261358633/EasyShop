						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="username"
									...
									value="${cookie.remebermeCookie.value}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label> <input type="checkbox" name="autoLogin"
										value="1"
										${not empty cookie.autoLoginCookie?"checked='checked'":""}>
										自动登录
									</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label> <input
										type="checkbox" name="remeberme" value="1"
										${not empty cookie.remebermeCookie?"checked ='checked'":""}>
										记住用户名
									</label>
								</div>
							</div>
