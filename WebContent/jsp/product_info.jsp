...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<form id="form1" action="${pageContext.request.contextPath}/CartServlet?method=addCart" method="post">
				<div style="margin: 0 auto; width: 950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin: 10px 0 10px 0;">
							亿家价: <strong style="color: #ef0101;">￥：${pro.shop_price}元/份</strong> 参 考 价：
						...
						<div
							...
							<div style="margin: 20px 0 10px 0;; text-align: center;">
								...
								<a href="javascript:void(0)"> <input
									...
									onclick="fu()" value="加入购物车" type="button">
								</a> &nbsp;收藏商品
							</div>
						</div>
					</div>
